...
game = account.games.create(server_id: player1.id, receiver_id: player2.id)

player1.participants.create(game_id: game.id)
player2.participants.create(game_id: game.id)

game.points.create(player_id: player1.id)
game.points.create(player_id: player1.id)
game.points.create(player_id: player2.id)
game.points.create(player_id: player2.id)
game.points.create(player_id: player2.id)
game.points.create(player_id: player2.id)
game.points.create(player_id: player1.id)
